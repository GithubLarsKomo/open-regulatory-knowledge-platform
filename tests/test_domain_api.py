...
class TestProductAPI:
    def test_create_product(self, client):
        resp = client.post(
            "/api/v1/products", params={"owner_user_id": "u1"}, json=_VALID_PRODUCT
        )
    ...
    def test_product_lifecycle(self, client):
        ...
        assert (
            client.post(
                f"/api/v1/products/{uid}/submit", params={"actor_user_id": "u1"}
            ).status_code
            == 200
        )
        assert (
            client.post(
                f"/api/v1/products/{uid}/approve", params={"actor_user_id": "u2"}
            ).status_code
            == 422
        )
    ...
    def test_delete_product(self, client):
        ...
        assert (
            client.delete(
                f"/api/v1/products/{uid}", params={"actor_user_id": "u1"}
            ).status_code
            == 204
        )
    ...
    def test_reject_unknown_fields(self, client):
        ...
        assert (
            client.post(
                "/api/v1/products", params={"owner_user_id": "u1"}, json=p
            ).status_code
            == 422
        )
    ...
    def test_add_device_variant(self, client):
        ...
        resp = client.post(
            f"/api/v1/products/{uid}/devices", params={"actor_user_id": "u1"}, json=dp
        )
    ...
    def test_link_claim_and_risk(self, client):
        ...
        cuid = client.post(
            "/api/v1/claims", params={"owner_user_id": "u1"}, json=_VALID_CLAIM
        ).json()["object_uuid"]
        ...
        assert (
            client.post(
                f"/api/v1/products/{puid}/claims/{cuid}", params={"actor_user_id": "u1"}
            ).status_code
            == 200
        )
        assert (
            client.post(
                f"/api/v1/products/{puid}/risks/{rid}", params={"actor_user_id": "u1"}
            ).status_code
            == 200
        )
        assert (
            client.get(f"/api/v1/products/{puid}/completeness").json()["complete"]
            is True
        )
...
class TestClaimAPI:
    ...
    def test_link_evidence_to_claim(self, client):
        ...
        euid = client.post(
            "/api/v1/evidence", params={"owner_user_id": "u1"}, json=_VALID_EVIDENCE
        ).json()["object_uuid"]
        resp = client.post(
            f"/api/v1/claims/{cuid}/link-evidence",
            params={"evidence_uuid": euid, "link_type": "supported_by"},
        )
    ...
    def test_claim_evidence_coverage_empty(self, client):
        ...
        assert (
            client.get(f"/api/v1/claims/{uid}/evidence-coverage").json()["has_evidence"]
            is False
        )
    ...
    def test_claim_lifecycle(self, client):
        ...
        assert (
            client.post(
                f"/api/v1/claims/{uid}/submit", params={"actor_user_id": "u1"}
            ).status_code
            == 200
        )
        ...
        assert (
            client.post(
                f"/api/v1/claims/{uid}/approve", params={"actor_user_id": "u2"}
            ).status_code
            == 422
        )
    ...
    def test_approve_with_evidence(self, client):
        ...
        assert (
            client.post(
                f"/api/v1/claims/{cuid}/approve", params={"actor_user_id": "u2"}
            ).status_code
            == 200
        )
    ...
    def test_reject_unknown_claim_fields(self, client):
        ...
        assert (
            client.post(
                "/api/v1/claims", params={"owner_user_id": "u1"}, json=p
            ).status_code
            == 422
        )
...
class TestEvidenceAPI:
    ...
    def test_evidence_lifecycle(self, client):
        ...
        assert (
            client.post(
                f"/api/v1/evidence/{uid}/submit", params={"actor_user_id": "u1"}
            ).status_code
            == 200
        )
        assert (
            client.post(
                f"/api/v1/evidence/{uid}/approve", params={"actor_user_id": "u2"}
            ).status_code
            == 200
        )
