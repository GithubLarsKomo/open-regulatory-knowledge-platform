...
CREATE TABLE IF NOT EXISTS regulatory_object (
    ...
    lifecycle_state VARCHAR(32)   NOT NULL DEFAULT 'draft' COMMENT 'draft|in_review|approved|effective|obsolete',
...
CREATE TABLE IF NOT EXISTS approval_record (
    ...
    decision            VARCHAR(32)   NOT NULL COMMENT 'approved|rejected|returned_to_draft',
