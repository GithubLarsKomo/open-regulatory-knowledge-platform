...
class PERReportService:
    ...
    def _build_payload(
        ...
        traceability.sort(
            key=lambda entry: (entry.object_type, entry.object_uuid, entry.version)
        )
                ...
                blocks=[
                    PERContentBlock(
                        ...
                        content={
                            ...
                            "legal_manufacturer": product_payload.get(
                                "legal_manufacturer"
                            ),
                        },
                        provenance="approved",
        ...
        section_sources = {
            ...
            "claims_and_evidence": by_type.get("claim", [])
                ...
                PERSection(
                    ...
                    blocks=[
                        PERContentBlock(
                            ...
                            content=[
                                entry.model_dump(mode="json") for entry in traceability
                            ],
